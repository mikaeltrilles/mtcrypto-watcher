export const SET_LIST_DISPLAY = 'CHANGE_VUE_LISTE'; // on définit le type de l'action (ici, SET_LIST_DISPLAY) qui sera utilisé dans le reducer (voir src/reducers/list.reducer.js)
